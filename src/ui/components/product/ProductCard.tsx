        ...
        <div className="flex flex-1 flex-col justify-center gap-2">
          ...
          <div className="mt-1 flex gap-2">
            ...
            >
              ...
              <span>{productHasStock(product) ? "Add to cart" : "Sold out"}</span>
            </button>
            <button
              type="button"
        ...
        <div className="relative aspect-[2/3] overflow-hidden rounded-lg bg-[#f0ece6] border border-black/5 shadow-xs">
          ...
          <div className="absolute inset-x-0 bottom-0 translate-y-full group-hover:translate-y-0 max-sm:translate-y-0 transition-transform duration-300 ease-out bg-white/95 backdrop-blur-md p-2.5 sm:p-3 border-t border-black/10 flex flex-col gap-1.5 sm:gap-2 z-20 shadow-lg">
            ...
            >
              ...
              <span>{productHasStock(product) ? `+ Quick Add · ${formatPrice(price)}` : "Sold Out"}</span>
            </button>
          </div>
        </div>
    ...
    <article className="group relative flex flex-col">
      <div className="relative aspect-[2/3] overflow-hidden bg-[#f3f0ec] rounded-xl border border-[#e6e2dc]/80 shadow-[0_4px_20px_rgba(0,0,0,0.05)] transition-all duration-300 group-hover:shadow-[0_8px_30px_rgba(0,0,0,0.1)]">
        ...
        <button
          ...
          aria-label={productHasStock(product) ? "Quick add to cart" : "Sold out"}
          title={productHasStock(product) ? "Quick add to cart" : "Sold out"}
        >
          <ShoppingBag className="h-4 w-4" />
        </button>
      </div>
